...
public class AlterarNomeProfessorController {
    ...
    void cOK(ActionEvent event) throws IOException{
    	...
    	try{
    		sp.alterarNomeProfessor(txtLogin.getText(), txtSenha.getText(), txtNewName.getText());
    		abrirAlertWarning();
    ...
    void abrirAlertErro() {
		Alert alert = new Alert(Alert.AlertType.ERROR);
		alert.setTitle("Erro 404! Informações não encontradas");
		alert.setHeaderText("Erro ao alterar o nome");
